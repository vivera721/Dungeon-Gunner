...
public class SoundEffectManager : SingletoneMonobehaviour<SoundEffectManager>
{
    ...
    public void PlaySoundEffect(SoundEffectSO soundEffect)
    {
        ...
        // 오브젝트 풀에서 사운드 게임오브젝트와 컴포넌트를 사용하여 사운드 재생
    ...
    /// <summary>
    /// Disalbe sound effect object after it has played thus returning it to the object pool
    /// </summary>
