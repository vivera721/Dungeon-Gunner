...
public class SoundEffectSO : ScriptableObject
{
    ...
    [Tooltip("The minimum pitch variation for the sound effect. " +
        "A random pitch variation wil be generated between the minimum and maximum values. " +
    ...
    #endregion
    [Range(0f, 1f)] public float soundEffectVloume = 1f;
    ...
    private void OnValidate()
    {
        ...
        HelperUtilities.ValidateCheckPositiveValue(this, nameof(soundEffectVloume), soundEffectVloume, true);
    }
#endif
    #endregion
