...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    #region Tooltip
    [Tooltip("Populate with the RectTransform of the child gameobject BarImage")]
    #endregion
    ...
    private void OnDisable()
    {
        ...
        // Unsubscirbe to weapon fired event
        player.weaponFiredEvent.OnWeaponFired -= WeaponFiredEvent_OnWeaponFired;

        // Unsubscirbe to reload weapon event
        player.reloadWeaponEvent.OnReloadWeapon -= ReloadWeaponEvent_OnReloadWeapon;

        // Unsubscirbe to weapon reloaded event
        player.weaponReloadedEvent.OnWeaponReloaded -= WeaponReloadedEvent_OnWeaponReloaded;
