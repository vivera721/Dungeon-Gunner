...
public class WeaponDetailsSO : ScriptableObject
{
    ...
    #region Header WEAPON OPERATION VALUES
    [Space(10)]
    [Header("WEAPON OPERATION VALUES")]
    #endregion
    #region Tooltip
    ...
    #region Tooltip
    [Tooltip("Weapon capacity - the maximum number of rounds at that can be held for this weapon")]
    #endregion
